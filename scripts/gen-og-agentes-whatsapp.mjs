// One-off generator for public/og-agentes-whatsapp.png (1200x630).
// Same visual style as gen-og-image.mjs but with copy specific to the
// /agentes-whatsapp landing page.
// Run: node scripts/gen-og-agentes-whatsapp.mjs
...
const out = resolve(__dirname, "..", "public", "og-agentes-whatsapp.png");
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <g transform="translate(80, 250)">
    <rect width="280" height="36" rx="18" fill="rgba(196, 160, 80, 0.12)" stroke="${GOLD}" stroke-opacity="0.4"/>
    <text x="20" y="24"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif"
          font-size="14" font-weight="600" fill="${GOLD}"
          letter-spacing="0.18em">
      AGENTES DE WHATSAPP · IA
    </text>
  </g>
  ...
  <g transform="translate(80, 350)">
    <text x="0" y="0"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif"
          font-size="86" font-weight="800" fill="#ffffff"
          letter-spacing="-0.04em">
      Tu negocio atiende
    </text>
    <text x="0" y="100"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif"
          font-size="86" font-weight="800" fill="url(#gold)"
          letter-spacing="-0.04em">
      24/7.
    </text>
  </g>
  ...
  <text x="80" y="528"
        font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif"
        font-size="26" font-weight="500" fill="${MUTED}"
        letter-spacing="-0.01em">
    Agentes de WhatsApp con IA — conversación humanizada.
  </text>
