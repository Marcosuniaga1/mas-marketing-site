// One-off generator for public/og-campanas-digitales.png (1200x630).
// Same visual style as gen-og-image.mjs but with copy specific to the
// /campanas-digitales landing page.
// Run: node scripts/gen-og-campanas-digitales.mjs
...
const out = resolve(__dirname, "..", "public", "og-campanas-digitales.png");
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="80" y="530"
    ...
    Meta Ads · Google Ads · Gestión completa
  </text>
