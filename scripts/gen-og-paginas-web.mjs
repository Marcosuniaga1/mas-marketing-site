// One-off generator for public/og-paginas-web.png (1200x630).
// Same visual style as gen-og-image.mjs but with copy specific to the
// /paginas-web landing page.
// Run: node scripts/gen-og-paginas-web.mjs
...
const out = resolve(__dirname, "..", "public", "og-paginas-web.png");
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <g transform="translate(80, 230)">
    <rect width="320" height="36" rx="18" fill="rgba(196, 160, 80, 0.12)" stroke="${GOLD}" stroke-opacity="0.4"/>
    <text x="20" y="24"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif"
          font-size="14" font-weight="600" fill="${GOLD}"
          letter-spacing="0.18em">
      PÁGINAS WEB · DESDE $180
    </text>
  </g>
  ...
  <text x="80" y="530"
    ...
    Diseñada para vender · Desde $180 USD
  </text>
