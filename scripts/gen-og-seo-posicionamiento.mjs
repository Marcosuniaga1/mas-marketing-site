// One-off generator for public/og-seo-posicionamiento.png (1200x630).
// Same visual style as gen-og-image.mjs but with copy specific to the
// /seo-posicionamiento landing page.
// Run: node scripts/gen-og-seo-posicionamiento.mjs
...
const out = resolve(__dirname, "..", "public", "og-seo-posicionamiento.png");
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <g transform="translate(80, 168)">
    <rect width="240" height="36" rx="18" fill="rgba(196, 160, 80, 0.12)" stroke="${GOLD}" stroke-opacity="0.4"/>
    <text x="20" y="24"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif"
  ...
  <g transform="translate(80, 280)">
    ...
    <text x="0" y="86"
          font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif"
          font-size="72" font-weight="800" fill="url(#gold)"
          letter-spacing="-0.04em">
      Y también en la IA.
    </text>
  </g>
